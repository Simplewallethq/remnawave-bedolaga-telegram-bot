...
- [Навигация интерфейса](#-навигация-интерфейса)
...
- Кнопка «Назад» возвращает на родительский экран, а не в главное меню.
- В главное меню можно вести только с экранов верхнего уровня.
- Текст кнопок берите из локали, а не задавайте строкой в коде.
