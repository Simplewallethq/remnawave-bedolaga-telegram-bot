...
async def handle_connect_platform_windows(
    ...
    text = (
        ...
        + texts.t(
            ...
            "<b>☀️ Leto VPN</b>\n"
            "Скачай по кнопке ниже, распакуй архив и запусти установщик. После "
            "установки войди через Telegram или вставь ключ доступа — ключ выше.\n\n"
            "<b>💻 Happ</b>\n"
        ...
        + texts.t(
            ...
            "Кнопка «Ключ в Happ» вставит ключ за тебя — копировать вручную не нужно.",
        )
    )
    await edit_or_answer_photo(
        callback,
...
async def handle_connect_platform_android_tv(
    ...
    text = texts.t(
        ...
        "1. Открой <b>Google Play</b> на телевизоре и найди в поиске "
        "<b>Leto VPN</b>. Установи приложение.\n"
        "2. Запусти Leto — на экране появится QR-код и код из 6 цифр.\n"
        "3. Дальше просто следуй инструкции на экране телевизора: "
        "отсканируй QR телефоном и подтверди вход.\n\n"
        "Вводить ключ доступа с пульта не нужно — вход подтверждается на телефоне, "
        "а телевизор подключится сам.",
    )
    await edit_or_answer_photo(
        callback,
        text,
