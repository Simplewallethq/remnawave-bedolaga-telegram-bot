...
def get_onboarding_connected_keyboard(language: str = DEFAULT_LANGUAGE) -> InlineKeyboardMarkup:
    ...
    """
    texts = get_texts(language)
    support_url = settings.get_support_contact_url() or "https://t.me/letovpnsupports"
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(
...
def get_support_keyboard(language: str = DEFAULT_LANGUAGE) -> InlineKeyboardMarkup:
    ...
    texts = get_texts(language)
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=texts.t("CONTACT_SUPPORT_BUTTON", "💬 Написать в поддержку"), url="https://t.me/letovpnsupports")],
