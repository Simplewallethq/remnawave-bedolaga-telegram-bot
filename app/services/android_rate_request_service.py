...
class AndroidRateRequestService:
    ...
    async def _send_rate_request(
        ...
        message = (
            "<b>Оцени Leto VPN и получи 50 ₽ на баланс</b>\n\n"
            "Как тебе Leto VPN для Android? Оставь отзыв в Google Play — "
            "в благодарность мы начислим 50 ₽ на баланс ❤️\n\n"
            "Для получения бонуса отправь скриншот опубликованного отзыва в поддержку."
        )
