...
class BotConfigurationService:
    ...
    CATEGORY_DESCRIPTIONS: Dict[str, str] = {
        ...
        "RAYS": "Начисление лучей за длительные покупки рефералов (тиры по периоду).",
    ...
    CATEGORY_KEY_OVERRIDES: Dict[str, str] = {
        ...
        "VPN_BRAND_NAME": "INTERFACE_BRANDING",
        "BRAND_HAS_OWN_APP": "INTERFACE_BRANDING",
        "BRAND_CHANNEL_ENABLED": "INTERFACE_BRANDING",
        "BRAND_RAYS_ENABLED": "INTERFACE_BRANDING",
        "PRIVACY_POLICY_URL": "INTERFACE_BRANDING",
        "TERMS_URL": "INTERFACE_BRANDING",
