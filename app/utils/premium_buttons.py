...
_EXACT_RULES: dict[str, tuple[str, str]] = {
    ...
    "➡️ Ключ в Happ": ("key_happ", "Ключ в Happ"),
    "🛠 Передать ключ в Happ": ("key_happ", "Передать ключ в Happ"),
    ...
    "🍎 Скачать Happ": ("apple", "Скачать Happ"),
    "🍎 Скачать Happ (Int. App Store)": ("apple", "Скачать Happ (Int. App Store)"),
